        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ceremonies</li>
                </ol>
            </nav>
        </div>
        <div class="d-sm-flex">
            ...
            <div class="col-md-7 col-lg-12 mg-t-10 mg-sm-t-10">
                <div >
                  ...
                  @endif
                    ...
                    <h5 id="section1" class="tx-semibold">Edit Detail Ceremonies (Adat Pernkahan)</h5>
          
                    <div class="card card-body pd-lg-25">
                      <form method="POST" action="{{ url('/akun/panel/ceremoniesin') }}" data-parsley-validate enctype="multipart/form-data">
                        @csrf
                        <div class="wd-300">
                            <div class="d-md-flex mg-b-30">
                              <div class="form-group mg-b-0">
                                <label>Wedding Ceremonies : <span class="tx-danger"></span></label>
                                <textarea type="text" name="penjelasan" class="form-control wd-lg-600 wd-sm-300" style="height: 150px;">{{$ceremonies->penjelasan}}</textarea>
                              </div><!-- form-group -->
                            </div><!-- d-flex -->
