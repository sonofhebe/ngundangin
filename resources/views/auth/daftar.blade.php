    ...
    <!-- App badge section-->
        <section class="bg-white" id="download">
            <div class="container col-md-5 px-5 mt-5">
                <h2 class="text-center text-black font-alt mb-4" data-aos="fade-in">Daftar</h2>
                <form method="POST" action="{{ url('/akun/daftar/add') }}">
                    @csrf
                    <!-- input-->
                    <div class="form-floating mb-3" data-aos="flip-down">
                        <input class="form-control border-primary" name="nama" type="text"
                            placeholder="Enter your name" required>
                        <label for="name">Nama</label>
                    </div>
                    <!-- input-->
                    <div class="input-group mb-3" data-aos="flip-down">
                        <div class="input-group-prepend">
                          <span class="form-control input-group-text border-primary">Link : ngundangin.online/</span>
                        </div>
                        <input class="form-control border-primary" name="link" type="text"
                            placeholder="Putra_Putri" required>
                            @if ($errors->has('link'))
                                <br><br><span class="text-danger text-left">{{ $errors->first('link') }}</span>
                            @endif
                    </div>
                    <!-- input-->
                    <div class="form-floating mb-3" data-aos="flip-down">
                    ...
                    <!-- Submit Button-->
                    <div class="d-grid" data-aos="flip-down"><button class="btn btn-primary rounded-pill btn-lg"
                            type="submit">Daftar</button></div>
                </form>
                <p class="text-center text-black font-alt mt-4 mb-4" data-aos="fade-in">Sudah punya akun? <a href="{{url('/akun/login/index')}}">Masuk.</a></p>
            </div>
        </section>
        <!-- App badge section-->
